    ...
    return GetBuilder<ServiceController>(builder: (serviceController){
      return serviceController.categoryList !=null ? SizedBox(
        ...
        child: ListView.builder(itemBuilder: (context,categoryIndex){
          ...
          return Container(
            height: Get.find<LocalizationController>().isLtr? 310:320,
            width: Get.width,
                  ...
                  Expanded(
                    child: GridView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return ServiceWidgetVertical(service: serviceController.categoryList![categoryIndex].servicesByCategory![index],fromType: '',);
                      },
                    ),
                  )
                ],),
