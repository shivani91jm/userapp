...
class _MenuScreenState extends State<MenuScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    int menuCountInSinglePage = ResponsiveHelper.isTab(context) ? 18 : 12;
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) => GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      crossAxisCount:  (menuCountInSinglePage/3).ceil(),
                    ...
                    itemCount: bottomNavController.currentMenuPageIndex + 1 < totalPageSize ? menuCountInSinglePage : (menuList.length % menuCountInSinglePage),
